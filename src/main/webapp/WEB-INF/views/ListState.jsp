    ...
    <section class="section dashboard">
        <div class="row" style="min-height: 500px;">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">State<span>/all</span></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="viewstate?stateId=${m.stateId}" class="btn btn-sm btn-primary">View</a>
                                                <a href="deletestate?stateId=${m.stateId}" class="btn btn-sm btn-danger">Delete</a>
                                                <a href="editstate?stateId=${m.stateId}" class="btn btn-sm btn-warning">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
