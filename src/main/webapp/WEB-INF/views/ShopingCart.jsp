	...
	<header class="header-v4">
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li><a href="#" class="label1 rs1" data-label1="hot">Features</a>
				</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-15 m-r--34  m-lr-0-xl">
...
<!-- 										<div class="wrap-num-product flex-w m-l-auto m-r-0">
 ...
 -->									
									...
									<span style="display: none;">${amt=amt+p[1]*p[4] }</span>
 </td>
									<td class="column-5">Rs.${p[1]*p[4]}</td>
									<td class="column-6"><a href="removecart?cartId=${p[5]}"><i class="zmdi zmdi-delete"></i>
									</a></td>
								</tr>
						</c:forEach>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span class="mtext-110 cl2"> Rs.${amt} + 0 <small>Delivery Fees</small></span>
							</div>
						</div>
 ...
 -->
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								<span class="mtext-110 cl2"> Rs.${amt} </span>
							</div>
						</div>

						<a href="checkout"
							class="btn flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					All rights reserved | Made with <i class="fa fa-heart-o"
						aria-hidden="true"></i> by <a href="home" target="_blank">E fashion
						</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
