	...
	<ul class="sidebar-nav" id="sidebar-nav" style="background: #A3B8D0;">
		...
		<li class="nav-item">
			<a class="nav-link" href="sellerdashboard">
				<i class="bi bi-grid"></i> <span>Seller Dashboard</span>
			</a>
		</li>
		<!-- End Dashboard Nav -->
		...
		<li class="nav-item">
			...
			<ul id="orderdetail-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
				...
				<li><a href="sellerlistorderdetail"> <i class="bi bi-circle"></i><span>List OrderDetail</span></a></li>
			</ul>
		</li>
		<!-- End OrderDetail Nav -->
		...
		<li class="nav-item">
			...
			<ul id="orders-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
				...
				<li><a href="sellerlistorders"> <i class="bi bi-circle"></i><span>List Orders</span></a></li>
			</ul>
		</li>
		<!-- End Orders Nav -->
		...
		<li class="nav-item">
			...
			<ul id="product-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
				...
				<li><a href="sellerlistproduct"> <i class="bi bi-circle"></i><span>List Product</span></a></li>
			</ul>
		</li>
		<!-- End Product Nav -->
		...
		<li class="nav-item">
			<a class="nav-link" href="sellerdashboard"> <i class="bi bi-person"></i> <span>Seller</span> </a>
		</li>
		<!-- End Seller Nav -->
